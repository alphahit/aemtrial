...
//Collects and sends performance data (Real User Monitoring) to a specified endpoint. This includes timing around specific checkpoints
// (like page load, interaction events)
//and possibly Core Web Vitals (CWV) metrics like CLS (Cumulative Layout Shift), FID (First Input Delay), LCP (Largest Contentful Paint), etc.
/**
...
//Sets up initial configurations, like RUM URL mask settings and code base paths.
// It might also determine if the page should be monitored based on URL parameters or session storage flags.
/**
 * Setup block utils.
 */
function setup() {
